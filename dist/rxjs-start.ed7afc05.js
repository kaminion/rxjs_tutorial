...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"rxjs-start.js":[function(require,module,exports) {
"use strict";
...
var promise1 = new Promise(function (resolve, reject) {
  resolve('promise 1');
}).then(console.log); // 일련의 데이터를 제공하고 subscribe 메서드에서 제공되는 옵저버에서 데이터를 읽을 수 있다. 실행시키려면 subscribe를 해야 실행이 된다. (실제 observer가 됨)
...
var intervalObsvr = new _rxjs.Observable(function (observer) {
  ...
  setInterval(function () {
    observer.next(i++); //observer.error(new Error("got error"))
...
(0, _rxjs.fromEvent)(document.getElementById("click-me"), "click").subscribe(function (data) {
  return console.log(data.target);
});
},{"rxjs":"node_modules/rxjs/_esm5/index.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "26708" + '/');
