...
(0, _rxjs.interval)(1000).pipe((0, _operators.tap)(console.log), (0, _operators.take)(3), (0, _operators.count)() // 인터벌과 같은 메서드에선 사용하기 힘듬, 앞에 complete되는 operator가 있어야함
).subscribe(console.log);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "32125" + '/');
...
//# sourceMappingURL=/rxjs.operator2.00016a7a.js.map