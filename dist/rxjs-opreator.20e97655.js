...
var operator = function operator(observable) {
...
myMap(function (v) {
  ...
  return v + 1;
})(myObservable))).subscribe(console.log); // 더 쉽게 쓰는 법 (pipe, 여러 operator 조합하여 함수형 프로그래밍 가능), 순수함수들만 전달가능

(0, _rxjs.from)([1, 2, 3, 4]).pipe( // stream을 만들 수 있음
// myMap(v => v + 1),
...
(0, _operators.reduce)(function (x, y) {
  return x + y;
}, 0) // 중첩된 값을 한번만 실행 함(complete 되는 순간에 전체 데이터를 한번에 계산)
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","rxjs-opreator.js"], null)
//# sourceMappingURL=/rxjs-opreator.20e97655.js.map